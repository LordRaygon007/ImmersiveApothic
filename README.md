NOTE: I'll depreciate this if Immersive Enchanting adds compatibility with Apotheosis natively; this is just a temporary "fix" I use in my private modpack.

This mod has two main features:

**1.** Prioritizes Immersive Enchanting's GUI over Apothic Enchanting.
